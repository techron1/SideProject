...
DownloadedFileDir="/home/abc/gitClonedFileUntar/"
JENKINS_DIR="/var/lib/Jenkins/jobs"
JMETER_DIR="/home/abc/Tools/apache-jmeter-5.2.1/"
buildName="FunctionalTest"
BuildDir="$JENKINS_DIR/$buildName"
mkdir -p $BuildDir

# Script Dir
BaseDir="/home/aaaa/RegressionTest"
...
cp $DownloadedFileDir/jmeterstyle.xml $JMETER_DIR/extras/jmeter-results-detail-report_211.xsl
